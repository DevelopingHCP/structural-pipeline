...
export MNI_T1=$FSLDIR/data/standard/MNI152_T1_1mm.nii.gz
...
export registration_config=$parameters_dir/parameters/ireg-structural.cfg
export registration_config_template=$parameters_dir/parameters/ireg.cfg
